 ...
 */
import type { CreateMyRecipeBodyDifficulty } from './createMyRecipeBodyDifficulty';
import type { CreateMyRecipeBodySectionsItem } from './createMyRecipeBodySectionsItem';
import type { CreateMyRecipeBodyYieldUnit } from './createMyRecipeBodyYieldUnit';

export type CreateMyRecipeBody = {
  /** @minLength 1 */
  title: string;
  /** @minLength 1 */
  description: string;
  ...
  categoryId: string;
  /** @minItems 1 */
  sections: CreateMyRecipeBodySectionsItem[];
  tagIds?: string[];
};
