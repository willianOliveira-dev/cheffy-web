...
export type CreateMyRecipeBodySectionsItemIngredientsItemUnit = typeof CreateMyRecipeBodySectionsItemIngredientsItemUnit[keyof typeof CreateMyRecipeBodySectionsItemIngredientsItemUnit];


export const CreateMyRecipeBodySectionsItemIngredientsItemUnit = {
  G: 'G',
  KG: 'KG',
  MG: 'MG',
  OZ: 'OZ',
