...
export type UpdateMyRecipeBodyYieldUnit = typeof UpdateMyRecipeBodyYieldUnit[keyof typeof UpdateMyRecipeBodyYieldUnit];


export const UpdateMyRecipeBodyYieldUnit = {
  PORTIONS: 'PORTIONS',
  PEOPLE: 'PEOPLE',
  UNITS: 'UNITS',
  SLICES: 'SLICES',
