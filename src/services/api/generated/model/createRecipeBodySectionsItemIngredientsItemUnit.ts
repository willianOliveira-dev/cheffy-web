...
export type CreateRecipeBodySectionsItemIngredientsItemUnit = typeof CreateRecipeBodySectionsItemIngredientsItemUnit[keyof typeof CreateRecipeBodySectionsItemIngredientsItemUnit];


export const CreateRecipeBodySectionsItemIngredientsItemUnit = {
  G: 'G',
  KG: 'KG',
  MG: 'MG',
  OZ: 'OZ',
