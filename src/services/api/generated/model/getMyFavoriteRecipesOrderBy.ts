...
export type GetMyFavoriteRecipesOrderBy = typeof GetMyFavoriteRecipesOrderBy[keyof typeof GetMyFavoriteRecipesOrderBy];


export const GetMyFavoriteRecipesOrderBy = {
  newest: 'newest',
  oldest: 'oldest',
} as const;
