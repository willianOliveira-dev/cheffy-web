 ...
 */
import type { RecipeSectionIngredientIngredientNutrition } from './recipeSectionIngredientIngredientNutrition';

export type RecipeSectionIngredientIngredient = {
  id: string;
  name: string;
  slug: string;
  /** @nullable */
  ...
  /** @nullable */
  nutrition?: RecipeSectionIngredientIngredientNutrition;
};
