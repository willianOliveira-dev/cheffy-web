...
export type UpdateRecipeBodyDifficulty = typeof UpdateRecipeBodyDifficulty[keyof typeof UpdateRecipeBodyDifficulty];


export const UpdateRecipeBodyDifficulty = {
  EASY: 'EASY',
  MEDIUM: 'MEDIUM',
  HARD: 'HARD',
  EXPERT: 'EXPERT',
